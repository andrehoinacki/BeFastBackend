...
public class JWTWebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity
				...
				.and()
				.authorizeRequests().antMatchers("/admin/produto/**").hasAnyRole("ADMIN","FUNCIONARIO")
				.and()
				.authorizeRequests().antMatchers("/admin/role/**").hasAnyRole("ADMIN","FUNCIONARIO")
				.and()
				.authorizeRequests().antMatchers("/admin/restricao/**").hasAnyRole("ADMIN","FUNCIONARIO")
				.and()
				.authorizeRequests().antMatchers("/admin/categoria/**").hasAnyRole("ADMIN","FUNCIONARIO")
				.and()
